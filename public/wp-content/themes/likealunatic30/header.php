 ...
 */
header("Content-Security-Policy: default-src 'self' 'unsafe-inline' *.google-analytics.com *.gravatar.com *.fontawesome.com *.images-amazon.com *.youtube.com *.amazon-adsystem.com; font-src 'self' data: *.fontawesome.com");
