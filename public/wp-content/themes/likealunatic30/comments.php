...
?>
  ...
  <?php
      $args = [
        ...
        'comment_field' =>
          '<div class="form-group"><label for="comment">' . _x( 'Comment', 'noun' ) .  '</label>' .
          '<textarea class="form-control" id="comment" name="comment" cols="45" rows="8"' .
          ' aria-required="true"></textarea></div>',
        //'comment_notes_after' => '<button type="submit" class="btn btn-default">コメントを送信</button>'
      ];
      comment_form($args);
  ?>
